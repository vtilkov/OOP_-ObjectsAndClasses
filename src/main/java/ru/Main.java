...
public class Main {
    ...
    /*Задание 3
    //принимает объеты интерфейса Measurable*/
    public static void printGetLength (Measurable... measurables){
        System.out.println(" Длины объектов ");
        for (int i = 0; i < measurables.length; i++) {
            System.out.println(" Объект " + (i + 1) + ": " + measurables[i].getLength());
        }
            System.out.println("----------------=");
    }
    public static void main(String[] args) {
        ...
        классов присутствует метод расчёта длины (getLength). Обеспечьте обоим классам общий интерфейс (Measurable). Разработайте
        метод, который принимает набор объектов, тип которых совпадает с разработанным
        интерфейсом. Передайте в этот метод одну обычную Ломаную из задачи №2 Замкнутая ломаная и
        ...
        //и одну Замкнутую и выведите результат на экран.
        ...
        System.out.println("Длина: " + closedLine.getLength());
        ...
        * Дано 2
        * класса, один описывает точку координат, а другой ломаную линию:
